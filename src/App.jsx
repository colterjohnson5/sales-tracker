...
const SalesTracker = ({ user, profile, onLogout, onProfileUpdate }) => {
  ...
  const CommunityLeaderboard = () => {
    ...
    React.useEffect(() => {
      if (leaderboardType === 'my-agency' && teamMembers.length === 0) {
    ...
    }, [leaderboardType, leaderboardPeriod, leagueSubType, nationalSubType]);

    return (
      <div className="space-y-4">
        <div className="text-center py-4"><h2 className="text-2xl font-bold text-gray-900">Leaderboard</h2></div>
        
        {/* Main tabs: My Agency / League / National */}
        <div className="flex gap-1 p-1.5 bg-gray-100 rounded-xl">
        ...
        {loadingLeaderboard || (isMyAgency && loadingTeam) ? (
